...
$item_color_a = $_POST["item_color_a"];
$item_color_b = $_POST["item_color_b"];
$item_color_c = $_POST["item_color_c"];
$item_color_d = $_POST["item_color_d"];
$item_color_e = $_POST["item_color_e"];
$id = $_POST["id"];
...
$sql = "UPDATE item_table SET style=:style, item=:item, value=:value, fabric=:fabric, size=:size, color_a=:color_a, color_b=:color_b, color_c=:color_c, color_d=:color_d, color_e=:color_e, movie=:movie, detail_a=:detail_a, detail_b=:detail_b, detail_c=:detail_c, detail_d=:detail_d, item_color_a=:item_color_a, item_color_b=:item_color_b, item_color_c=:item_color_c, item_color_d=:item_color_d, item_color_e=:item_color_e WHERE id=:id";
